  ...
  return (
    <html lang="en">
      ...
      <body className="bg-black text-white">
        <Navbar />
        {children}
        <footer className="w-full bg-black text-white py-8 mt-24 border-t border-amber-900/40">
          <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-lg font-bold" style={{ color: goldMat }}>Perfect Models Management © {new Date().getFullYear()}</div>
            <div className="flex space-x-6">
              <a href="https://www.facebook.com/perfectmodels.ga" target="_blank" rel="noopener noreferrer" aria-label="Facebook" style={{ color: goldMat }}>
              ...
              <a href="https://www.instagram.com/perfectmodels.ga/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{ color: goldMat }}>
              ...
              <a href="https://www.tiktok.com/@perfectmodels.ga" target="_blank" rel="noopener noreferrer" aria-label="TikTok" style={{ color: goldMat }}>
              ...
              <a href="https://www.youtube.com/channel/UCNICmN3GVzZFb6gsD3-efSQ" target="_blank" rel="noopener noreferrer" aria-label="YouTube" style={{ color: goldMat }}>
