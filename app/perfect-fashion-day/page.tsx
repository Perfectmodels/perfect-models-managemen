...
import AttestationsCarousel from "@/components/attestations-carousel";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-gradient-to-r from-amber-50 to-amber-100 rounded-lg p-8 mb-24">
            ...
            <div className="max-w-2xl mx-auto mb-12">
              <h4 className="text-xl font-bold text-center mb-4 text-amber-700">Golden Partners – Attestations de Participation</h4>
              <AttestationsCarousel />
            </div>
          </div>
