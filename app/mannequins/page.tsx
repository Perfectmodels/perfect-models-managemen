          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mb-16">
            {femaleModels.map((model, index) => {
              ...
              const normalized = model
                .toLowerCase()
                .replace(/\s*\(.*\)/, "") // retire les parenthèses et ce qu'il y a dedans
                .replace(/[^a-z0-9]/g, ""); // retire les espaces et caractères spéciaux
              // Chercher toutes les photos correspondantes
              const files = [
